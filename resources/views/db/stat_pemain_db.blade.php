                                    ...
                                    <table class="table table-striped table tablesorter" id="ipi-table">
                                        <thead class="thead-dark">
                                            <tr class="justify-content-center align-items-center align-content-center">
                                                ...
                                                <th class="text-center">Menit bermain</th>
                                        ...
                                        <tbody class="text-center">
                                            @if ($data->count() > 0)
                                            @foreach($data as $stat_pemain)
                                            <tr>
                                                <td>{{ $stat_pemain->ID_Statistik }}</td>
                                                <td>{{ $stat_pemain->ID_Pemain }}</td>
                                                <td>{{ $stat_pemain->Menit_bermain }}</td>
                                                <td>{{ $stat_pemain->Jumlah_Gol }}</td>
                                                <td>{{ $stat_pemain->Jumlah_Assist }}</td>
                                                <td>{{ $stat_pemain->Kartu_Kuning }}</td>
                                                <td>{{ $stat_pemain->Kartu_Merah }}</td>
                                                <td>{{ $stat_pemain->Penyelamatan }}</td>
                                                <td>{{ $stat_pemain->Clean_Sheet }}</td>
                                                <td>{{ $stat_pemain->Jumlah_Pertandingan }}</td>
                                                <td class="text-center align-middle" style="max-height: 60px; height: 60px;">
                                                    <a class="btn btnMaterial btn-flat success semicircle" role="button" href="{{ route('stat_pemain.edit', $stat_pemain->ID_Statistik) }}"><i class="fas fa-pen"></i></a>
                                                    <form action="{{ route('stat_pemain.destroy', $stat_pemain->ID_Statistik) }}" method="POST" onsubmit="return confirm('Delete?')">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn btnMaterial btn-flat accent btnNoBorders checkboxHover" style="margin-left: 5px;">
