                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table tablesorter" id="ipi-table">
                                        ...
                                        <tbody class="text-center">
                                            ...
                                            <tr>
                                                <td>{{ $news->ID_Berita }}</td>
                                                <td>{{ $news->penulis }}</td>
                                                <td>{{ $news->isi_berita }}</td>
                                                <td>{{ $news->gabar_berita }}</td>
                                                ...
                                                <td class="text-center align-middle" style="max-height: 60px;height: 60px;">
                                                    ...
                                                    <a class="btn btnMaterial btn-flat accent btnNoBorders checkboxHover" role="button" style="margin-left: 5px;" data-bs-toggle="modal" data-bs-target="#delete-modal" href="#"><i class="fas fa-trash btnNoBorders" style="color: #DC3545;"></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                            @else
