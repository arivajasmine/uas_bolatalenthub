                                    ...
                                    <table class="table table-striped table tablesorter" id="ipi-table">
                                        ...
                                        <tbody class="text-center">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $tim->Asal_Negara }}</td>
                                                <td>{{ $tim->ID_Kompetisi }}</td>
                                                <td class="text-center align-middle" style="max-height: 60px; height: 60px;">
                                                    <a class="btn btnMaterial btn-flat success semicircle" role="button" href="{{ route('tim.edit', $tim->ID_Tim) }}"><i class="fas fa-pen"></i></a>
                                                    <form action="{{ route('tim.destroy', $tim->ID_Tim) }}" method="POST" onsubmit="return confirm('Delete?')">
                                                        @csrf
                                                        @method('DELETE')
