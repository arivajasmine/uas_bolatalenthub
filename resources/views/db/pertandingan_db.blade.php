                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table tablesorter" id="ipi-table">
                                        ...
                                        <tbody class="text-center">
                                            ...
                                            <tr>
                                                <td>{{ $pertandingan->ID_Pertandingan }}</td>
                                                <td>{{ $pertandingan->ID_Kompetisi }}</td>
                                                <td>{{ $pertandingan->Tanggal_Pertandingan }}</td>
                                                <td>{{ $pertandingan->Tim_Tuan_Rumah }}</td>
                                                <td>{{ $pertandingan->Tim_Tamu }}</td>
                                                <td>{{ $pertandingan->Skor_Tuan_Rumah }}</td>
                                                <td>{{ $pertandingan->Skor_Tamu }}</td>
                                                <td>{{ $pertandingan->Jumlah_Penonton }}</td>
                                                <td class="text-center align-middle" style="max-height: 60px; height: 60px;">
                                                    <a class="btn btnMaterial btn-flat success semicircle" role="button" href="{{ route('pertandingan.edit', $pertandingan->ID_Pertandingan) }}"><i class="fas fa-pen"></i></a>
                                                    <form action="{{ route('pertandingan.destroy', $pertandingan->ID_Pertandingan) }}" method="POST" onsubmit="return confirm('Delete?')">
                                                        @csrf
                                                        @method('DELETE')
