                                    ...
                                    <table class="table table-striped table tablesorter" id="ipi-table">
                                        ...
                                        <tbody class="text-center">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $pemain->Tanggal_Lahir }}</td>
                                                <td>{{ $pemain->Tempat_Lahir }}</td>
                                                ...
                                                <td class="text-center align-middle" style="max-height: 60px; height: 60px;">
                                                    <a class="btn btnMaterial btn-flat success semicircle" role="button" href="{{ route('pemain.edit', $pemain->ID_Pemain) }}"><i class="fas fa-pen"></i></a>
                                                    <form action="{{ route('pemain.destroy', $pemain->ID_Pemain) }}" method="POST" onsubmit="return confirm('Delete?')">
                                                        @csrf
                                                        @method('DELETE')
